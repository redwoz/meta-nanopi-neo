...
load mmc 0:1 ${fdt_addr_r} ${fdtfile} || load mmc 0:1 ${fdt_addr_r} boot/${fdtfile} || load mmc 0:1 ${fdt_addr_r} uImage-${fdtfile} || load mmc 0:1 ${fdt_addr_r} boot/uImage-${fdtfile}
